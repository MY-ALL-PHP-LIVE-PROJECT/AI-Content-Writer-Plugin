...
else
{
    ...
    else
    {
        ...
        {
            echo '<option value="' . esc_attr($myassistant->ID) .'">' . esc_html($myassistant->post_title);
            echo '</option>';
        }
    }
}
...
?>                                        
                ...
                <p>
                <label for="aiomatic_vision_selector"><strong><?php esc_html_e( 'AI Vision', 'aiomatic-automatic-ai-content-writer' ); ?></strong></label><br />
                <select id="aiomatic_vision_selector" name="aiomatic_vision_selector" class="aiomatic-full">
                <option value="off"><?php echo esc_html__("Off", 'aiomatic-automatic-ai-content-writer'); ?></option>     
                <option value="on"><?php echo esc_html__("On", 'aiomatic-automatic-ai-content-writer'); ?></option>            
            </select>
                </p>
                <p>
...
else
{
    ...
    else
    {
        ...
        if($post) 
        {
            ...
            <p>
                <label for="aiomatic_rename_file_checkbox"><strong><?php esc_html_e( 'Automatically Rename Image File Based On Title', 'aiomatic-automatic-ai-content-writer' ); ?></strong></label>&nbsp;
                <select id="aiomatic_rename_file_checkbox" name="aiomatic_rename_file_checkbox" class="aiomatic-full">
                    <option value="off"><?php echo esc_html__("Off", 'aiomatic-automatic-ai-content-writer'); ?></option>     
                    <option value="on"><?php echo esc_html__("On", 'aiomatic-automatic-ai-content-writer'); ?></option>            
                </select>
            </p>
            <p>
                ...
                <textarea name="title" class="aiomatic-full" id="aiomatic_attachment_title"><?php echo esc_textarea($post->post_title); ?></textarea>
            </p>
            <p>
                <label for="aiomatic_attachment_caption"><strong><?php esc_html_e( 'File Name', 'aiomatic-automatic-ai-content-writer' ); ?></strong></label><br />
                <?php $file_path = get_attached_file( $post->ID );?>
                <input type="url" class="aiomatic-full" disabled id="aiomatic_file_name" value="<?php echo esc_attr($file_path);?>">
            </p>
            <p class="attachment-alt-text">
                ...
                <input type="hidden" id="aiomatic_media_id" value="<?php echo esc_attr($GLOBALS["aiomatic_image_id"]);?>">
            </p>
            ...
            <p>
                ...
                <textarea name="excerpt" class="aiomatic-full" id="aiomatic_attachment_caption"><?php echo esc_textarea($post->post_excerpt); ?></textarea>
            </p>
            <p>
                <label for="attachment_content" class="attachment-content-description"><strong><?php esc_html_e( 'Description', 'aiomatic-automatic-ai-content-writer' ); ?></strong>
                <?php
                ...
                <textarea name="content" class="aiomatic-full" id="attachment_content"><?php echo esc_textarea($post->post_content); ?></textarea>
            </p>
            </div>
        <?php
        }
...
<?php esc_html_e( 'Preview image:', 'aiomatic-automatic-ai-content-writer' );?>
                        ...
                        <div class="imgedit-group imgedit-applyto">
                            <figure class="imgedit-thumbnail-preview">
                                <img src="<?php 
    echo esc_url($thumb['url']); ?>" width="<?php echo esc_attr($thumb_img[0]); ?>" height="<?php echo esc_attr($thumb_img[1]); ?>" class="imgedit-size-preview" alt="" draggable="false" />
                                <figcaption class="imgedit-thumbnail-preview-caption"><?php esc_html_e( 'Current thumbnail', 'aiomatic-automatic-ai-content-writer' ); ?></figcaption>
                            </figure>
                        </div>
<?php
    }
