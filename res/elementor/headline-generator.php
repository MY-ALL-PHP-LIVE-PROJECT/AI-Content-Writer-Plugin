        ...
        public function register_openai_settings_controls(Controls_Stack $element, $section_id) {
            ...
            $element->add_control(
                ...
                [
                    ...
                    'default' => AIOMATIC_DEFAULT_MODEL,
                ]
            );
            $element->add_control(
            ...
            try {
                ...
                if (isset($aiomatic_Main_Settings['app_id']) && trim($aiomatic_Main_Settings['app_id']) != '') 
                {
                    ...
                    if(!empty($prompt))
                    {
                        ...
                        $aierror = '';
                        $finish_reason = '';
                        $generated_text = aiomatic_generate_text($token, $model, $prompt, $available_tokens, $temperature, $top_p, $presence_penalty, $frequency_penalty, false, 'ElementorWriter', 0, $finish_reason, $aierror, false, false, false, '', '', 'user', $assistant, $thread_id, '', 'disabled', '', false, false, array());
